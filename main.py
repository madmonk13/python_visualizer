...
Rotation Options:
  ...
  Starfield: none (outward only), cw (clockwise), ccw (counter-clockwise)
    ...
    parser.add_argument('-t', '--text', 
                       help='Text overlay line 1 to display below cover (optional)')
    
    parser.add_argument('-t2', '--text2', 
                       help='Text overlay line 2 to display below cover (optional)')
    ...
    parser.add_argument('--waveform-rotation', default='none',
                       choices=['none', 'cw', 'ccw'],
    ...
    parser.add_argument('--ring-scale', type=float, default=1.0,
                       help='Ring scale multiplier (default: 1.0, try 0.5-2.0)')
    
    parser.add_argument('--waveform-orientation', default='horizontal',
                       choices=['horizontal', 'vertical'],
                       help='Waveform orientation: horizontal (default) or vertical')
    
    parser.add_argument('--cover-timeline', default='none',
                       choices=['none', 'fade', 'zoom', 'slide_up', 'slide_down'],
                       help='Cover timeline animation (default: none)')
    ...
    if args.cover_timeline != 'none':
        print(f"  Cover Timeline: {args.cover_timeline}")
    ...
    visualizer = MusicVisualizer(
        ...
        cover_timeline=args.cover_timeline,
        ring_stagger=args.ring_stagger
    )
